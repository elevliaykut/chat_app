...
class PostActivityTypeHelper
{
    public const POST_ACTIVITY_TYPE_LIKE               = 1;
    public const POST_ACTIVITY_TYPE_MAKE_FAVORITE      = 2;
    public const POST_ACTIVITY_TYPE_SMILE              = 3;
