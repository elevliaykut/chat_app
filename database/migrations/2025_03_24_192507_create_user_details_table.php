...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('user_details', function (Blueprint $table) {
            ...
            $table->boolean('want_a_child')->nullable();
            $table->boolean('use_cigarette')->nullable();
            ...
            $table->boolean('do_you_pray')->nullable();
            $table->boolean('do_you_know_quran')->nullable();
            $table->boolean('are_you_fasting')->nullable();
